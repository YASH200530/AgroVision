      ...
      <div className="max-w-lg w-full space-y-10 bg-gray-800/90 backdrop-blur-md rounded-3xl p-10 border-2 border-gray-700/50 shadow-2xl">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-lg font-bold text-gray-300 mb-3 font-display">
                {t('auth.name')}
              </label>
            ...
            <div>
              <label htmlFor="email" className="block text-lg font-bold text-gray-300 mb-3 font-display">
                {t('auth.email')}
              </label>
              <div className="relative">
            ...
            <div>
              <label htmlFor="language" className="block text-lg font-bold text-gray-300 mb-3 font-display">
                {t('auth.language')}
              </label>
              <select
                id="language"
                ...
                className="appearance-none relative block w-full px-6 py-4 border-2 border-gray-600 text-lg text-white rounded-2xl focus:outline-none focus:ring-4 focus:ring-agri-300 focus:border-agri-500 font-medium bg-gray-700/80 backdrop-blur-sm cursor-pointer shadow-sm"
              >
